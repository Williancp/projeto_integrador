...
class _UsuarioFormScreenState extends State<UsuarioFormScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.isEditing ? 'Editar Usuário' : 'Novo Usuário'),
        elevation: 0,
      ),
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: widget.isEditing ? 'Senha (deixe em branco para não alterar)' : 'Senha',
                    ...
                    validator: (value) {
                      if (!widget.isEditing && (value?.isEmpty ?? true)) {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        RadioListTile<String>(
                          title: const Text('Usuário Comum'),
